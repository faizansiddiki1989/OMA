      ...
      try {
        ...
        if(currentRecord.type == "customerpayment"){
          if(context.fieldId == "custbody_tobc_busi_id"){
               if(formid == 212) {
                if(department == 106 && deptClass == 14){
                ...
                var business = currentRecord.getValue({
                  ...
                  currentRecord.setValue({fieldId: "custbody_tobc_bus_type_tax",value: 2})
                  currentRecord.setValue({fieldId: "custbody_tobc_trns_type_tax",value: 1})
              }else{
              ...
              if (department == 106 && deptClass == 14 && formid == 212 && btype ==3) {
