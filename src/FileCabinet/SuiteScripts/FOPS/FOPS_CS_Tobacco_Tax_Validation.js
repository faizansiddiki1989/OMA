...
/********************************
 * File Name : FOPS CS Tabaco Tax Validation
 * Purpose   : To validate data entered from UI
 *
 * History
 * Date             Author              Details
*/
define(["N/ui/dialog", "N/https"], function (dialog, https) {
    ...
    var fields = [
        ...
        { 'id': 'custrecord_tobc_cust_tax', 'label': 'Customer' },
        { 'id': 'custrecord_tobc_tax_pay_id', 'label': 'Tax Payer Id Number' },
        { 'id': 'name', 'label': 'Business Name' },
        { 'id': 'custrecord_tobc_tax_pay_id_num', 'label': 'Confirm Tax Payer Id Number' },
        { 'id': 'custrecord_tobc_add1_tax', 'label': 'Address Line1' },
        { 'id': 'custrecord_tobc_city_tax', 'label': 'City' },
        { 'id': 'custrecord_tobc_state_tax', 'label': 'State' },
        { 'id': 'custrecord_tobc_zip_tax', 'label': 'Zip' },

        { 'id': 'custrecord_tobc_ctper_tax', 'label': 'Contact Person' },
        { 'id': 'custrecord_tobc_tele_tax', 'label': 'Contact Telephone' },
        { 'id': 'custrecord_tobc_name_tax', 'label': 'Corporate Name' },
        { 'id': 'custrecord_tobc_mail_address_line1', 'label': 'Mailing Address Line 1' },
        //{ 'id': 'custrecord_tobc_mail_address_line2', 'label': 'Mailing Address Line 2' },

        { 'id': 'custrecord_tobc_mail_state_tax', 'label': 'Mailing State' },
        { 'id': 'custrecord_tobc_mail_city_tax', 'label': 'Mailing City' },
        { 'id': 'custrecord_tobc_mail_zip_tax', 'label': 'Mailing Zip' },
        { 'id': 'custrecord_tobc_mail_cc_tax', 'label': 'Mailing Corporate Contact' },
        { 'id': 'custrecord_tobc_mail_ct_tax', 'label': 'Mailing Contact Telephone' },
        { 'id': 'custrecord_tobc_mail_busi_open_date_tax', 'label': 'Business Open Date' },
        { 'id': 'custrecord_tobc_mail_pay_per_tax', 'label': 'Payment Period' },
        //{'id': 'custrecord_tobc_add2_tax', 'label': 'Address Line 2'}
    ];
    ...
    function pageInit(context) {
        debugger;
        jQuery("#custrecord_tobc_tax_pay_id_num,#custrecord_tobc_tax_pay_id").keyup(function (e) {
            taxNumberFormat(e);
        });

        jQuery("#custrecord_tobc_tele_tax,#custrecord_tobc_mail_ct_tax").keyup(function (e) {
            telePhoneNumberFormat(e)
        });

        openDateinit = context.currentRecord.getValue({ fieldId: 'custrecord_tobc_mail_busi_open_date_tax' });

        var mandatoryTag = '<label class="uir-required-icon">*</label>';
        jQuery("#custrecord_tobc_mail_city_tax_fs_lbl").append(mandatoryTag);
        jQuery("#custrecord_tobc_mail_state_tax_fs_lbl").append(mandatoryTag);
        jQuery("#custrecord_tobc_mail_zip_tax_fs_lbl").append(mandatoryTag);
        jQuery("#custrecord_tobc_mail_address_line1_fs_lbl").append(mandatoryTag);
    ...
    function validateField(context) {
        ...
        if (context.fieldId = "custrecord_tobc_tax_pay_id") {
            var taxnumber = currentRecord.getValue({ fieldId: "custrecord_tobc_tax_pay_id" });
            if (taxnumber != '') {
                ...
                alert('validateField'); currentRecord.setValue({ fieldId: "custrecord_tobc_tax_pay_id", value: finalStr, ignoreFieldChange: true });
    ...
    function fieldChanged(context) {
        ...
        try {
            ...
            else if (context.fieldId == "custrecord_tobc_tax_pay_id_num") {
                confirmTax(currentRecord, option)
            } else if (context.fieldId == "name") {
                nameName(currentRecord, option)
            } else if (context.fieldId == "custrecord_tobc_add1_tax") {
                address1(currentRecord, option)
            } else if (context.fieldId == "custrecord_tobc_add2_tax") {
                address2(currentRecord, option)
            } else if (context.fieldId == "custrecord_tobc_city_tax") {
            ...
            else if (context.fieldId == "custrecord_tobc_zip_tax") {
                zipcode(currentRecord, option)
            } else if (context.fieldId == "custrecord_tobc_ctper_tax") {
                taxPerson(currentRecord, option)
            } else if (context.fieldId == "custrecord_tobc_tele_tax") {
                telephoneNumber(currentRecord, option)
            } else if (context.fieldId == "custrecord_tobc_name_tax") {
                corporateName(currentRecord, option)
            } else if (context.fieldId == "custrecord_tobc_mail_address_line1") {
                malingAddress1(currentRecord, option)
            } else if (context.fieldId == "custrecord_tobc_mail_address_line2") {
                malingAddress2(currentRecord, option)
            } else if (context.fieldId == "custrecord_tobc_mail_city_tax") {
                malingCity(currentRecord, option)
            } else if (context.fieldId == "custrecord_tobc_mail_zip_tax") {
                malingZip(currentRecord, option)
            } else if (context.fieldId == "custrecord_tobc_mail_cc_tax") {
                malingCorporateName(currentRecord, option)
            } else if (context.fieldId == "custrecord_tobc_mail_ct_tax") {
                malingTelephone(currentRecord, option)
            } else if (context.fieldId == "custrecord_tobc_mail_busi_open_date_tax") {
                var changeDate = currentRecord.getValue({ fieldId: 'custrecord_tobc_mail_busi_open_date_tax' });
                if (changeDate != openDateinit) {
                    falg = true
                }
            } else if (context.fieldId == "custrecord_tobaco_same_asabove") {
                // same as above
                var sameAsAbove = currentRecord.getValue({
                    fieldId: "custrecord_tobaco_same_asabove",
                });
                if (sameAsAbove) {
                    currentRecord.setValue({
                        fieldId: "custrecord_tobc_name_tax",
                    ...
                    currentRecord.setValue({
                        fieldId: "custrecord_tobc_mail_address_line1",
                        value: currentRecord.getValue({
                            fieldId: "custrecord_tobc_add1_tax",
                        }),
                        ignoreFieldChange: true
                    });
                    currentRecord.setValue({
                        fieldId: "custrecord_tobc_mail_address_line2",
                        value: currentRecord.getValue({
                            fieldId: "custrecord_tobc_add2_tax",
                        }),
                        ignoreFieldChange: true
                    });
                    currentRecord.setValue({
                        fieldId: "custrecord_tobc_mail_state_tax",
                        value: currentRecord.getValue({
                            fieldId: "custrecord_tobc_state_tax",
                        }),
                        ignoreFieldChange: true
                    });
                    currentRecord.setValue({
                        fieldId: "custrecord_tobc_mail_city_tax",
                        value: currentRecord.getValue({
                            fieldId: "custrecord_tobc_city_tax",
                        }),
                        ignoreFieldChange: true
                    });
                    currentRecord.setValue({
                        fieldId: "custrecord_tobc_mail_zip_tax",
                        value: currentRecord.getValue({
                            fieldId: "custrecord_tobc_zip_tax",
                        }),
                        ignoreFieldChange: true
                    });
                    currentRecord.setValue({
                        fieldId: "custrecord_tobc_mail_cc_tax",
                        value: currentRecord.getValue({
                            fieldId: "custrecord_tobc_ctper_tax",
                        }),
                        ignoreFieldChange: true
                    });
                    currentRecord.setValue({
                        fieldId: "custrecord_tobc_mail_ct_tax",
                        value: currentRecord.getValue({
                            fieldId: "custrecord_tobc_tele_tax",
                        }),
                        ignoreFieldChange: true
                    });
                }
    ...
    function saveRecord(context) {
        try {
            ...
            for (var i = 0; i < fields.length; i++) {
                ...
                if(fields[i].id  == 'custrecord_tobc_mail_bus_opebn_date_tax')
                  value = currentRecord.getValue('custrecord_tobc_mail_bus_opebn_date_tax');
    ...
    function taxId(currentRecord, option, saveRecord) {
        ...
        if (taxnumber && !taxregex.test(taxnumber)) {
            ...
            if (!saveRecord) {
                ...
                dialog.alert(option);
                currentRecord.setValue({
                    fieldId: 'custrecord_tobc_tax_pay_id',
                    value: '',
                    ignoreFieldChange: true,
                    forceSyncSourcing: false
                });
                document.getElementById('custrecord_tobc_tax_pay_id').focus();
    ...
    function confirmTax(currentRecord, option, saveRecord) {
        var taxnumber = currentRecord.getValue({ fieldId: "custrecord_tobc_tax_pay_id" });
        var confTaxnumber = currentRecord.getValue({ fieldId: "custrecord_tobc_tax_pay_id_num" });
        ...
        if (taxnumber && confTaxnumber && taxnumber == confTaxnumber) {
            ...
            if (taxnumber.length != 10 && confTaxnumber.length != 10) {
                if (!saveRecord) {
                    dialog.alert(option);
                    currentRecord.setValue({
                        fieldId: 'custrecord_tobc_tax_pay_id_num',
                        value: '',
                        ignoreFieldChange: true,
                        forceSyncSourcing: false
                    });
                    document.getElementById('custrecord_tobc_tax_pay_id_num').focus();
                }
                if (saveRecord) {
                    return obj
                }
    ...
    function telephoneNumber(currentRecord, option, saveRecord) {
        ...
        if (businesstelephone && !businesstelephoneregex.test(businesstelephone)) {
            if (!saveRecord) {
                ...
                document.getElementById('custrecord_tobc_tele_tax').focus();
    ...
    function malingTelephone(currentRecord, option, saveRecord) {
        ...
        if (mallingtelephone && !mallingtelephoneRegx.test(mallingtelephone)) {
            if (!saveRecord) {
                ...
                document.getElementById('custrecord_tobc_mail_ct_tax').focus();
            }
    ...
    function BusinessOpenDate(currentRecord, option, saveRecord) {
        var openDate = currentRecord.getValue({
            fieldId: "custrecord_tobc_mail_busi_open_date_tax",
        });
    ...
    function BusinessPaymentPeriod(currentRecord, option, saveRecord) {
        var period = currentRecord.getValue({
            fieldId: "custrecord_tobc_mail_pay_per_tax",
        });
    ...
    function paymentsInDb(id)
    {
        ...
        //     ["type","anyof","CustPymt"],
        //     "AND",
        //     ["custbody_business_type","is", BUSINESS_TYPE.TOBACCO],
        //     "AND",
        ...
        var filters = [
            ...
            ["custbody_business_type","is", BUSINESS_TYPE.TOBACCO],
            "AND",
            ["custbody_tobc_business_id", "anyof", id],
            "AND",
            ["mainline","is","T"]
        ];

        var columns = ['custbody_rest_total_occ_enty','custbody_tax_year','custbody_tax_month','custbody_quarterly'];
