      ...
      try {
        ...
        if (currentRecord.type == "customerpayment") {
          if (context.fieldId == "custbody_hotel_busniess_name_id") {
            if (formid == FILECONSTANT.PAYMENTFORMS.HOTEL) {
              if (department == FILECONSTANT.FOPS.DEPARTMENT && deptClass == FILECONSTANT.FOPS.CLASS) {
                ...
                if (business) {
                  ...
                  currentRecord.setValue({ fieldId: "custbody_business_type", value: FILECONSTANT.HOTEL_BUSINESSTYPE })
                  currentRecord.setValue({ fieldId: "custbody_transaction_type", value: FILECONSTANT.TRANS_TYPE.MAIL })
            ...
            if (department == FILECONSTANT.FOPS.DEPARTMENT && deptClass == FILECONSTANT.FOPS.CLASS && formid == FILECONSTANT.PAYMENTFORMS.HOTEL && btype == FILECONSTANT.HOTEL_BUSINESSTYPE) {
              ...
              var fieldLookUp = search.lookupFields({
                ...
                id: FILECONSTANT.HOTEL_BUSINESSTYPE,
                columns: [
                  'custrecord35'
                ]
              });
