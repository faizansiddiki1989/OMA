        ...
        if(context.mode == "create"){
          ...
          if(transType == TRANS_TYPE.MAIL){
            currentRecord.setValue({
              ...
              value: FILECONSTANT.PAYMENT_STATUS.PROCESSED  //PROCESSED ID
            });
          }
        }
      ...
      if (runtime.executionContext == 'USERINTERFACE') {
        ...
        try {
          ...
          if (fieldName == 'custbody_fops_payment_status') {
            ...
            if( FILECONSTANT.ALLOWED_PAYMENT_STATUS.indexOf(paymentStatus) == -1){
              var option = {
                title: "Insufficient Permission",
          ...
          if (fieldName == "custbody_rest_tax_bus_id") {
            ...
            if (department == FILECONSTANT.FOPS.DEPARTMENT && deptClass == FILECONSTANT.FOPS.CLASS) {
              ...
              if (business) {
                ...
                currentRecord.setValue({ fieldId: "custbody_transaction_type", value: TRANS_TYPE.MAIL });
                currentRecord.setValue({ fieldId: "custbody_fops_payment_status", value: FILECONSTANT.PAYMENT_STATUS.PROCESSED });
    ...
    function onloadValidationDisable(currentRecord, onload) {
      ...
      if (business) {
        ...
        if (onload == 'create') {
          ...
          currentRecord.setValue({
            fieldId: "custbody_transaction_type",
            value: TRANS_TYPE.MAIL,
            ignoreFieldChange: true,
          });
          currentRecord.setValue({
            fieldId: "custbody_fops_payment_status",
            value: FILECONSTANT.PAYMENT_STATUS.PROCESSED,
            ignoreFieldChange: true,
          });
        }
      }
